// variable creating
var guest = ["Ahmad", "sami", "Altaf", "tariq"];
// variable for notify of the missing person
var DontCome = guest[1];
...
var MiddleNumber = Math.floor(guest.length / 2);
// Add middle value in the Array by using Splice
guest.splice(MiddleNumber, 0, "AmjAd");
guest.forEach(function (guest) { return console.log("Salam ".concat(guest, " join the dinner")); });
...
while (guest.length > 2) {
    ...
    console.log("Salam ".concat(guest, " sorry you are not invited"));
}
// Inviting rest guests
guest.forEach(function (guest) { return console.log(" luckily ".concat(guest, " you are remained guests")); });
